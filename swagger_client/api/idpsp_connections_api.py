...
class IdpspConnectionsApi(object):
    ...
    def add_connection_cert(self, id, body, **kwargs):  # noqa: E501
        """Add a new SP connection certificate.  # noqa: E501
        ...
        :param str id: ID of the SP Connection to update. (required)
    ...
    def add_connection_cert_with_http_info(self, id, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/idp/spConnections/{id}/credentials/certs', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def create_connection(self, body, **kwargs):  # noqa: E501
        """Create a new SP connection.  # noqa: E501

        Create a new SP connection. If the SP connection is not properly configured, a 422 status code is returned along with a list of validation errors that must be corrected.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param SpConnection body: Configuration for new connection. (required)
    ...
    def create_connection_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='SpConnection',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def delete_connection(self, id, **kwargs):  # noqa: E501
        """Delete an SP connection.  # noqa: E501

        Delete an SP connection with the specified ID. A 404 status code is returned for nonexistent IDs. Note: Only inactive connections can be deleted. If the request succeeds, the response body is empty. If the request fails, an ApiResult is returned with details of the error.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param str id: ID of SP Connection to delete. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def get_connection(self, id, **kwargs):  # noqa: E501
        """Find SP connection by ID.  # noqa: E501

        Get an SP connection with the specified ID. A 404 status code is returned for nonexistent IDs.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param str id: ID of the SP Connection to fetch. (required)
        :return: SpConnection
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def get_connection_certs(self, id, **kwargs):  # noqa: E501
        """Get the SP connection's certificates.  # noqa: E501
        ...
        :param async_req bool
        :param str id: ID of the SP Connection. (required)
    ...
    def get_connection_certs_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/idp/spConnections/{id}/credentials/certs', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_connections(self, **kwargs):  # noqa: E501
        """Get list of SP connections.  # noqa: E501

        Get a list of all the WS-Fed, WS-Trust, SAML1.0, SAML1.1 and SAML 2.0 SP connections.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param str filter: Filter criteria limits the SP connections that are returned to only those that match it. The filter criteria is compared to the SP connection name and partner entity ID fields. The comparison is a case-insensitive partial match. No additional pattern based matching is supported.
    ...
    def get_connections_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='SpConnections',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_decryption_keys(self, id, **kwargs):  # noqa: E501
        """Get the decryption keys of an SP connection.  # noqa: E501
    ...
    def get_decryption_keys_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/idp/spConnections/{id}/credentials/decryptionKeys', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_signing_settings(self, id, **kwargs):  # noqa: E501
        """Get the SP connection's signature settings.  # noqa: E501
    ...
    def get_signing_settings_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/idp/spConnections/{id}/credentials/signingSettings', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_connection(self, id, body, **kwargs):  # noqa: E501
        """Update an SP connection.  # noqa: E501

        Update an SP connection with the matching ID. If the SP connection is not properly configured, a 422 status code is returned along with a list of validation errors that must be corrected. Note: A 404 status code is returned for nonexistent IDs.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param str id: ID of SP Connection to update. (required)
        :param SpConnection body: Configuration for updated connection. (required)
        :param bool x_bypass_external_validation: External validation will be bypassed when set to true. Default to false.
        :return: SpConnection
                 If the method is called asynchronously,
                 returns the request thread.
    ...
    def update_connection_certs(self, id, body, **kwargs):  # noqa: E501
        """Update the SP connection's certificates.  # noqa: E501
    ...
    def update_connection_certs_with_http_info(self, id, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/idp/spConnections/{id}/credentials/certs', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_decryption_keys(self, id, body, **kwargs):  # noqa: E501
        """Updating the SP connection's decryption keys.  # noqa: E501
    ...
    def update_decryption_keys_with_http_info(self, id, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/idp/spConnections/{id}/credentials/decryptionKeys', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_signing_settings(self, id, body, **kwargs):  # noqa: E501
        """Update the SP connection's signature settings.  # noqa: E501
    ...
    def update_signing_settings_with_http_info(self, id, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/idp/spConnections/{id}/credentials/signingSettings', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
