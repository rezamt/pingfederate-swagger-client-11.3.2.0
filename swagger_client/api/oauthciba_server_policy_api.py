...
class OauthcibaServerPolicyApi(object):
    ...
    def create_policy(self, body, **kwargs):  # noqa: E501
        ...
        Create a new request policy. If the request policy is not properly configured, a 422 status code is returned along with a list of validation errors that must be corrected.  # noqa: E501
        ...
        :param RequestPolicy body: Configuration for new policy. (required)
    ...
    def create_policy_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/oauth/cibaServerPolicy/requestPolicies', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='RequestPolicy',  # noqa: E501
    ...
    def delete_policy(self, id, **kwargs):  # noqa: E501
        ...
        Delete a request policy with the specified ID. A 404 status code is returned for nonexistent IDs. Note: If the request succeeds, the response body is empty. If the request fails, an ApiResult is returned with details of the error.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param str id: ID of request policy to delete. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def delete_policy_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/oauth/cibaServerPolicy/requestPolicies/{id}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_policies_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/oauth/cibaServerPolicy/requestPolicies', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='RequestPolicies',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_policy(self, id, **kwargs):  # noqa: E501
        ...
        Get a request policy with the specified ID. A 404 status code is returned for nonexistent IDs.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param str id: ID of the request policy to fetch. (required)
        :return: RequestPolicy
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def get_policy_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/oauth/cibaServerPolicy/requestPolicies/{id}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_settings_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/oauth/cibaServerPolicy/settings', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='CibaServerPolicySettings',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_policy(self, id, body, **kwargs):  # noqa: E501
        ...
        Update a request policy with the matching ID. If the policy is not properly configured, a 422 status code is returned along with a list of validation errors that must be corrected. Note: A 404 status code is returned for nonexistent IDs.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param str id: ID of the request policy to update. (required)
        :param RequestPolicy body: Configuration for updated policy. (required)
        :param bool x_bypass_external_validation: External validation will be bypassed when set to true. Default to false.
        :return: RequestPolicy
                 If the method is called asynchronously,
                 returns the request thread.
    ...
    def update_policy_with_http_info(self, id, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/oauth/cibaServerPolicy/requestPolicies/{id}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_settings(self, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param CibaServerPolicySettings body: Ciba server request policy settings. (required)
        :param bool x_bypass_external_validation: External validation will be bypassed when set to true. Default to false.
        :return: CibaServerPolicySettings
                 If the method is called asynchronously,
                 returns the request thread.
    ...
    def update_settings_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/oauth/cibaServerPolicy/settings', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
