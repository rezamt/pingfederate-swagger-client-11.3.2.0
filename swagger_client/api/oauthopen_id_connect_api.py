...
class OauthopenIdConnectApi(object):
    ...
    def create_policy(self, body, **kwargs):  # noqa: E501
        """Create a new OpenID Connect Policy.  # noqa: E501

        Create a new OpenID Connect Policy. If the OpenID Connect policy is not properly configured, a 422 status code is returned along with a list of validation errors that must be corrected.  # noqa: E501
        ...
        :param OpenIdConnectPolicy body: Configuration for new policy. (required)
    ...
    def create_policy_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/oauth/openIdConnect/policies', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='OpenIdConnectPolicy',  # noqa: E501
    ...
    def delete_policy(self, id, **kwargs):  # noqa: E501
        """Delete an OpenID Connect Policy.  # noqa: E501

        Delete an OpenID Connect Policy with the specified ID. A 404 status code is returned for nonexistent IDs. Note: If the request succeeds, the response body is empty. If the request fails, an ApiResult is returned with details of the error.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param str id: ID of OpenID Connect Policy to delete. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def delete_policy_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/oauth/openIdConnect/policies/{id}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_policies(self, **kwargs):  # noqa: E501
        """Get list of OpenID Connect Policies.  # noqa: E501
    ...
    def get_policies_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/oauth/openIdConnect/policies', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='OpenIdConnectPolicies',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_policy(self, id, **kwargs):  # noqa: E501
        """Find OpenID Connect Policy by ID.  # noqa: E501

        Get an OpenID Connect Policy with the specified ID. A 404 status code is returned for nonexistent IDs.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param str id: ID of the OpenID Connect Policy to fetch. (required)
        :return: OpenIdConnectPolicy
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def get_policy_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/oauth/openIdConnect/policies/{id}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_settings(self, **kwargs):  # noqa: E501
        """Get the OpenID Connect Settings.  # noqa: E501
    ...
    def get_settings_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/oauth/openIdConnect/settings', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='OpenIdConnectSettings',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_policy(self, id, body, **kwargs):  # noqa: E501
        """Update an OpenID Connect Policy.  # noqa: E501

        Update an OpenID Connect Policy with the matching ID. If the policy is not properly configured, a 422 status code is returned along with a list of validation errors that must be corrected. Note: A 404 status code is returned for nonexistent IDs.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param str id: ID of the OpenID Connect Policy to update. (required)
        :param OpenIdConnectPolicy body: Configuration for updated policy. (required)
        :param bool x_bypass_external_validation: External validation will be bypassed when set to true. Default to false.
        :return: OpenIdConnectPolicy
                 If the method is called asynchronously,
                 returns the request thread.
    ...
    def update_policy_with_http_info(self, id, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/oauth/openIdConnect/policies/{id}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_settings(self, body, **kwargs):  # noqa: E501
        """Set the OpenID Connect Settings.  # noqa: E501
        ...
        :param async_req bool
        :param OpenIdConnectSettings body: OpenID Connect Settings. (required)
        :return: OpenIdConnectSettings
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def update_settings_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/oauth/openIdConnect/settings', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
