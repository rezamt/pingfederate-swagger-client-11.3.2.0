...
class CaptchaProvider(object):
    ...
    def __init__(self, id=None, name=None, plugin_descriptor_ref=None, parent_ref=None, configuration=None, _configuration=None):  # noqa: E501
        """CaptchaProvider - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this CaptchaProvider.  # noqa: E501
        ...
        :return: The id of this CaptchaProvider.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this CaptchaProvider.

        The ID of the plugin instance. The ID cannot be modified once the instance is created.<br>Note: Ignored when specifying a connection's adapter override.  # noqa: E501

        :param id: The id of this CaptchaProvider.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this CaptchaProvider.  # noqa: E501
        ...
        :return: The name of this CaptchaProvider.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this CaptchaProvider.

        The plugin instance name. The name can be modified once the instance is created.<br>Note: Ignored when specifying a connection's adapter override.  # noqa: E501

        :param name: The name of this CaptchaProvider.  # noqa: E501
        :type: str
        """
    ...
    def plugin_descriptor_ref(self):
        """Gets the plugin_descriptor_ref of this CaptchaProvider.  # noqa: E501
        ...
        :return: The plugin_descriptor_ref of this CaptchaProvider.  # noqa: E501
        :rtype: ResourceLink
        """
    ...
    def plugin_descriptor_ref(self, plugin_descriptor_ref):
        """Sets the plugin_descriptor_ref of this CaptchaProvider.

        Reference to the plugin descriptor for this instance. The plugin descriptor cannot be modified once the instance is created.<br>Note: Ignored when specifying a connection's adapter override.  # noqa: E501

        :param plugin_descriptor_ref: The plugin_descriptor_ref of this CaptchaProvider.  # noqa: E501
        :type: ResourceLink
        """
    ...
    @property
    def parent_ref(self):
        """Gets the parent_ref of this CaptchaProvider.  # noqa: E501
        ...
        :return: The parent_ref of this CaptchaProvider.  # noqa: E501
        :rtype: ResourceLink
        """
    ...
    def parent_ref(self, parent_ref):
        """Sets the parent_ref of this CaptchaProvider.

        The reference to this plugin's parent instance. The parent reference is only accepted if the plugin type supports parent instances.<br>Note: This parent reference is required if this plugin instance is used as an overriding plugin (e.g. connection adapter overrides)  # noqa: E501

        :param parent_ref: The parent_ref of this CaptchaProvider.  # noqa: E501
        :type: ResourceLink
        """
    ...
    def configuration(self):
        """Gets the configuration of this CaptchaProvider.  # noqa: E501

        Plugin instance configuration.  # noqa: E501

        :return: The configuration of this CaptchaProvider.  # noqa: E501
    ...
    def configuration(self, configuration):
        """Sets the configuration of this CaptchaProvider.

        Plugin instance configuration.  # noqa: E501

        :param configuration: The configuration of this CaptchaProvider.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CaptchaProvider, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CaptchaProvider):
            return False
