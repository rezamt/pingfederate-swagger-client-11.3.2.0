...
class SsoOAuthMapping(object):
    ...
    def __init__(self, attribute_sources=None, attribute_contract_fulfillment=None, issuance_criteria=None, _configuration=None):  # noqa: E501
        """SsoOAuthMapping - a model defined in Swagger"""  # noqa: E501
    ...
    def attribute_sources(self):
        """Gets the attribute_sources of this SsoOAuthMapping.  # noqa: E501

        A list of configured data stores to look up attributes from.  # noqa: E501

        :return: The attribute_sources of this SsoOAuthMapping.  # noqa: E501
    ...
    def attribute_sources(self, attribute_sources):
        """Sets the attribute_sources of this SsoOAuthMapping.

        A list of configured data stores to look up attributes from.  # noqa: E501

        :param attribute_sources: The attribute_sources of this SsoOAuthMapping.  # noqa: E501
    ...
    def attribute_contract_fulfillment(self):
        """Gets the attribute_contract_fulfillment of this SsoOAuthMapping.  # noqa: E501

        A list of mappings from attribute names to their fulfillment values.  # noqa: E501

        :return: The attribute_contract_fulfillment of this SsoOAuthMapping.  # noqa: E501
    ...
    def attribute_contract_fulfillment(self, attribute_contract_fulfillment):
        """Sets the attribute_contract_fulfillment of this SsoOAuthMapping.

        A list of mappings from attribute names to their fulfillment values.  # noqa: E501

        :param attribute_contract_fulfillment: The attribute_contract_fulfillment of this SsoOAuthMapping.  # noqa: E501
    ...
    def issuance_criteria(self):
        """Gets the issuance_criteria of this SsoOAuthMapping.  # noqa: E501

        The issuance criteria that this transaction must meet before the corresponding attribute contract is fulfilled.  # noqa: E501

        :return: The issuance_criteria of this SsoOAuthMapping.  # noqa: E501
    ...
    def issuance_criteria(self, issuance_criteria):
        """Sets the issuance_criteria of this SsoOAuthMapping.

        The issuance criteria that this transaction must meet before the corresponding attribute contract is fulfilled.  # noqa: E501

        :param issuance_criteria: The issuance_criteria of this SsoOAuthMapping.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SsoOAuthMapping, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SsoOAuthMapping):
            return False
